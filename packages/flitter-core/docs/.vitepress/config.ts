...
export default defineConfig({
  title: 'Flitter',
  description: 'Flutter-faithful TUI framework — TypeScript/Bun',
  lang: 'zh-CN',
  lastUpdated: true,
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '示例', link: '/examples/' },
      {
        text: '相关链接',
        items: [
          { text: 'GitHub', link: 'https://github.com/LIGHTYEARS/flitter' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/LIGHTYEARS/flitter' }
    ],
