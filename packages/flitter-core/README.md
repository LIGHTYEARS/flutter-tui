...
Core TUI framework for the [Flitter](https://github.com/LIGHTYEARS/flitter) monorepo.

A Flutter-faithful terminal UI framework for TypeScript and Bun.
